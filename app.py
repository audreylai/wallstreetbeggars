...
def rules():
	...
	stock_data = get_stock_data_chartjs(get_stock_data(ticker, period=180), ticker=ticker, period=180)
...
def stock_info():
	...
	stock_data = get_stock_data_chartjs(get_stock_data(ticker, 180), interval=1, ticker=ticker, period=180)
	stock_info = get_stock_info(ticker)
